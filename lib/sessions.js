...
export default class Session {
  ...
  async currentUser () {
    return await (this.organizer ? findOrganizer : findAttendee)(this.email);
  }
  ...
  static async create (email, role, limited) { // allow "limited" sessions for quick attendee actions that can be force-expired
