...
export async function generatePass({ user }) {
  ...
  pass.backFields.add({
    "key": "app",
    "value": "st.hack.af",
    "label": "Manage your ticket",
    "attributedValue": "https://st.hack.af"
  })

  pass.backFields.add({
    "key": "address",
    "value": "651 Dolores St, San Francisco, CA 94110",
    "attributedValue": "http://maps.apple.com/?address=651+Dolores+St,+San Francisco,+CA+94110",
    "label": "Address",
    "dataDetectorTypes": "PKDataDetectorTypeAddress",
    "changeMessage": "Address changed to %@"
  })

  pass.backFields.add({
    key: "website",
    value: "https://summit.hackclub.com",
    label: "Website",
    attributedValue: `<a href="https://summit.hackclub.com">Summit Website</a>`
  });
